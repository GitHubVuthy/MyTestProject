...
*/
			...
			if (!$json) {
				...
				/*$order_data['delivery_id']= $this->request->post['delivery_id'];*/
				...
				$order_data['shipping_address']= $this->session->data['customer']['shipping_address'];
				$order_data['comment']= $this->session->data['customer']['comment'];
				$order_data['customer_group_id']= $this->session->data['customer']['customer_group_id'];
			...
			/*	$order_data['telephone'] = $this->session->data['customer']['telephone'];*/
				...
				/*$order_data['delivery_id'] = $this->session->data['customer']['delivery_id'];*/
