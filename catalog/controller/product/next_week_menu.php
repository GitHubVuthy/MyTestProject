<?php
class ControllerProductNextWeekMenu extends Controller {
	public function index() {
		$this->load->language('product/next_week_menu');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('product/next_week_menu', $url)
		);
