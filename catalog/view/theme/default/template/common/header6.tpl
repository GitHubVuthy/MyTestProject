  ...
  <nav id="menu" class="navbar">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
     <ul class="nav navbar-nav">
      <li><a href="<?php echo ; ?>"><?php echo $category['name']; ?></a></li>
   <?php if ($categories) { ?>
    ...
    <li class="dropdown">
     <a tabindex="-1" href="<?php echo $category['href']; ?>" class="dropdown-toggle" data-toggle="dropdown"><?php echo $info_category['name']; ?></a>
      ...
      <div class="dropdown-menu">
        <div class="dropdown-inner">
          ...
          <ul class="nav dropdown-inner">
            <?php foreach ($info_children as $info_child) { ?>
              ...
              <li class="dropdown-submenu" >
                 <a  href="<?php echo $info_child['href']; ?>" class="dropdown-toggle" data-toggle="dropdown"><?php echo $info_child['name']; ?></a>
        ...
        <a href="<?php echo $info_category['href']; ?>" class="see-all"><?php echo $text_all; ?> <?php echo $info_category['name']; ?></a> </div>
    </li>
    <?php } else { ?>
