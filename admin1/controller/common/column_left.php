...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/info_category')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_info_category'),
					'href'     => $this->url->link('catalog/info_category', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			*/	
			...
			if ($this->user->hasPermission('access', 'sale/order2')) {
				$sale[] = array(
					'name'	   => $this->language->get('text_quick_order2'),
					'href'     => $this->url->link('sale/order2', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			

			if ($this->user->hasPermission('access', 'sale/order1')) {
				$sale[] = array(
					'name'	   => $this->language->get('text_quick_order'),
					'href'     => $this->url->link('sale/order1', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'delivery/delivery')) {
				$delivery[] = array(
					'name'	   => $this->language->get('text_delivery'),
					'href'     => $this->url->link('delivery/delivery', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			
			
			if ($this->user->hasPermission('access', 'delivery/delivery1')) {
				$delivery[] = array(
					'name'	   => $this->language->get('text_delivery1'),
					'href'     => $this->url->link('delivery/delivery1', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			...
			*/// Report
			...
			if ($this->user->hasPermission('access', 'report/delivery_order')) {	
				$report_delivery[] = array(
					'name'	   => $this->language->get('text_delivery'),
					'href'     => $this->url->link('report/delivery_order', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
