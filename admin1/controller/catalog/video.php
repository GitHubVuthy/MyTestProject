...
class ControllerCatalogVideo extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_video->addInformation($this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_video->editInformation($this->request->get['video_id'], $this->request->post);
	...
	protected function getList() {
		...
		$information_total = $this->model_catalog_video->getTotalInformations();

		$results = $this->model_catalog_video->getInformations($filter_data);
...
// Information Categories
		...
		if (isset($this->request->post['info_category'])) {
			...
			$infocategories = $this->model_catalog_video->getInformationCategory($this->request->get['information_id']);
		} else {
...
//Related Information Test1
		...
		foreach ($related_informations_test as $related_information_id_test) {
			$related_information_info_test = $this->model_catalog_video->getInformationDescriptionTest($related_information_id_test);
		...
		if (isset($this->request->get['video_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$information_info = $this->model_catalog_video->getInformation($this->request->get['video_id']);
		}
		...
		if (isset($this->request->post['video_description'])) {
			...
			$data['video_description'] = $this->model_catalog_video->getInformationDescriptions($this->request->get['video_id']);
		} else {
		...
		/*if (isset($this->request->post['information_store'])) {
			...
			$data['information_store'] = $this->model_catalog_video->getInformationStores($this->request->get['information_id']);
		} else {
...
*/
	/*	if (isset($this->request->post['keyword'])) {
		...
		if (isset($this->request->post['information_layout'])) {
			...
			$data['information_layout'] = $this->model_catalog_video->getInformationLayouts($this->request->get['information_id']);
		} else {
	...
	/*protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $video_id) {
			...
			$store_total = $this->model_setting_store->getTotalStoresByInformationId($video_id);
