...
class ModelCatalogInfoCategory extends Model {
	...
	public function getInfoCategoryDescriptions($category_id) {
	...
	public function getCategoryPath($category_id) {
		$query = $this->db->query("SELECT category_id, path_id, level FROM " . DB_PREFIX . "info_category_path WHERE category_id = '" . (int)$category_id . "'");
