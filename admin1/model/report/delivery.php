<?php
class ModelReportDelivery extends Model {
	public function getTotalDeliveryByDay() {
		$customer_data = array();
		...
		$query = $this->db->query("SELECT COUNT(*) AS total, HOUR(date_added) AS hour FROM `" . DB_PREFIX . "delivery` WHERE DATE(date_added) = DATE(NOW()) GROUP BY HOUR(date_added) ORDER BY date_added ASC");
	...
	public function getTotalDeliveryByWeek() {
		$customer_data = array();
	...
	public function getTotalDeliveryByMonth() {
		$customer_data = array();
	...
	public function getTotalDiliveryByYear() {
		$customer_data = array();
	...
	public function getOrders($data = array()) {
		$sql = "SELECT d.delivery_id, CONCAT(d.firstname, ' ', d.lastname) AS delivery, o.order_id, SUM(op.quantity) as products, SUM(o.total) AS total FROM `" . DB_PREFIX . "order` o LEFT JOIN `" . DB_PREFIX . "order_product` op ON (o.order_id = op.order_id) LEFT JOIN `" . DB_PREFIX . "delivery` d ON (o.delivery_id = d.delivery_id) WHERE o.delivery_id > 0 ";
	...
	public function getTotalOrders($data = array()) {
		$sql = "SELECT COUNT(DISTINCT o.delivery_id) AS total FROM `" . DB_PREFIX . "order` o LEFT JOIN `" . DB_PREFIX . "delivery` d ON (o.delivery_id = d.delivery_id) WHERE o.delivery_id > '0'";
