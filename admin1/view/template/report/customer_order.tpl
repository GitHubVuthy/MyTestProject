        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-6">
			  ...
			  <button type="button" id="button-export" class="btn btn-primary pull-right"><i class="fa fa-institution"></i> Export Data</button>
            </div>
          </div>
        </div>
...
$('#button-export').on('click', function() {
  url = 'index.php?route=report/customer_order/export&token=<?php echo $token; ?>';
