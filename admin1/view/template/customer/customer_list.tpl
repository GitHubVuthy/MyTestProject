          ...
          <div class="row">
            <div class="col-sm-3">
              ...
              <div class="form-group">
                ...
                <input type="text" name="filter_telephone" value="<?php echo $filter_telephone; ?>" placeholder="Telephone" id="input-telephone" class="form-control" />
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
            ...
            <div class="col-sm-3">
              ...
              <button type="button" id="button-filter" class="btn btn-primary pull-right" style="margin-left:10px"><i class="fa fa-filter"></i> <?php echo $button_filter; ?></button>
              <button type="button" id="button-export" class="btn btn-primary pull-right"><i class="fa fa-files-o"></i> <?php echo $button_export; ?></button>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'c.telephone') { ?>
                    <a href="<?php echo $sort_telephone; ?>" class="<?php echo strtolower($order); ?>">Telephone</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_telephone; ?>">Telephone</a>
                    <?php } ?></td>
