...
function addAddress() {
	...
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][city]" value="Phnom Penh" placeholder="<?php echo $entry_city; ?>" id="input-city' + address_row + '" class="form-control" /></div>';
	html += '  </div>';
    ...
    html += '         <option value="36"><?php echo "Cambodia"; ?></option>';
    <?php foreach ($countries as $country) { ?>
	...
	html += '    <div class="col-sm-10"><select name="address[' + address_row + '][zone_id]" id="input-zone' + address_row + '" class="form-control"><option value="567"><?php echo "Phnom Penh"; ?></option></select></div>';
	html += '  </div>';*/
