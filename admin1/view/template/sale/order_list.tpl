  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="button" id="button-delete" form="form-order" formaction="<?php echo $delete; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" disabled><i class="fa fa-trash-o"></i></button>
      </div>
        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <button type="button" id="button-export" class="btn btn-primary pull-right"><i class="fa fa-institution"></i> <?php echo $button_export; ?></button>
            </div>
          </div>
        </div>
