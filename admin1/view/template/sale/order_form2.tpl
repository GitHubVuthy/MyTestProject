                ...
                <div class="col-sm-10">
                 ...
                 <div class="form-group">
                  ...
                  <select name="delivery_id" id="input-delivery" class="form-control">
                      <option value="" >---Choose Delivery Men---</option>; 
                      <?php foreach ($deliveries as $delivery) { ?>
                      <?php if ($delivery['delivery_id'] == $delivery_id) { ?>
                      <option value="<?php echo $delivery['delivery_id']; ?>" selected="selected"><?php echo $delivery['delivery_id']. $delivery['fname'] ; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $delivery['delivery_id']; ?>"><?php echo $delivery['delivery_id']. $delivery['fname'] ; ?></option>
                      <?php } ?>
                      <?php } ?>
                  </select>
...
$('input[name=\'customer\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#tab-customer select option').not($('#tab-customer select[name=\'store_id\'] option,#tab-customer select[name=\'delivery_id\'] option,  #tab-customer select[name=\'currency\'] option')).removeAttr('selected');
    ...
    //$('#tab-customer select[name=\'delivery_id\']').val(item['delivery_id']);
...
$('#button-save').on('click', function() {
	if ($('input[name=\'order_id\']').val() == 0) {
		var url = '<?php echo $catalog; ?>index.php?route=api/order2/add&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val();
	} else {
		var url = '<?php echo $catalog; ?>index.php?route=api/order2/edit&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&order_id=' + $('input[name=\'order_id\']').val();
	}
