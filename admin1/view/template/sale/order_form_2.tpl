            ...
            <div class="tab-pane" id="tab-cart">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 text-right">
                  <button type="button" onclick="$('a[href=\'#tab-shipping\']').tab('show');" class="btn btn-primary"><i class="fa fa-arrow-right"></i> <?php echo $button_continue; ?></button>
                </div>
              <!--
                <div class="col-sm-6 text-right">
...
$('#button-save').on('click', function() {
	if ($('input[name=\'order_id\']').val() == 0) {
		var url = '<?php echo $catalog; ?>index.php?route=api/order1/add&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val();
	} else {
		var url = '<?php echo $catalog; ?>index.php?route=api/order1/edit&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&order_id=' + $('input[name=\'order_id\']').val();
	}
