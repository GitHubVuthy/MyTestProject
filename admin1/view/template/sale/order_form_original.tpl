          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-customer">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="payment_add" id="input-shipping-address" class="form-control">
              ...
              <div class="form-group required">
                <label class="col-sm-2 fcontrol-label" for="input-lastname"><?php echo $entry_lastname; ?></label>
                <div class="col-sm-10">
...
$('input[name=\'customer\']').autocomplete({
	...
	'select': function(item) {
		...
		$('select[name=\'shipping_add\']').html(html);
